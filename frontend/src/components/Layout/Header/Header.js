...
import TemporaryDrawer from '../../Misc/Drawer/Drawer';
        ...
        {!isAuthenticated && !user && !loading ? 
          <div>
            <MenuItem component={Link} to="/signin">
              <IconButton color="inherit"><LockOpenIcon /></IconButton>Sign In
            </MenuItem>
            <MenuItem component={Link} to="/signup">
              <IconButton color="inherit"><PersonAddIcon /></IconButton>Sign Up
            </MenuItem>
          </div>
        :isAuthenticated && user && !loading ?
          <div>
            <MenuItem component={Link} to="/myprofile">
              <IconButton color="inherit"><AccountCircle /></IconButton>Profile
            </MenuItem>
            <MenuItem onClick={onLogOut}>
              <IconButton color="inherit"><ExitToAppIcon /></IconButton>Log Out
            </MenuItem>
          </div>
        :null}
      </Menu>
              ...
              <AppBar position="sticky">
                  <Toolbar className="header">
                    ...
                    <div className={classes.search}>
                        ...
                        />
                        <button style={{display: "none"}} onClick={handleSearch} type="submit">
                          search
                        </button>
                        </form>
                    </div>
                    <div className="header__categories">
                      {Categories.slice(0, categoriesNum).map(c => (
                        <MenuItem 
                          key={c} 
                          value={c}
                          onClick={() => { 
                      ...
                      <TemporaryDrawer 
                        items={Categories.slice(categoriesNum)}
                        direction="top"
                        onClickItem={(e) => { 
                          setCategory(e.target.textContent);
                          history.push(`/search?category=${e.target.textContent}`);
                        }}
                        openButtonText={<ExpandMoreIcon />}
                        OpenButtonComponent={MenuItem}
                      />
                    </div>
