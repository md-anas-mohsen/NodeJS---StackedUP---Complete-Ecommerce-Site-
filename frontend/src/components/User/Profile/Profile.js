    ...
    return (
        <div className="profile">
            ...
            <Grid direction="row" container justifyContent="center">
                <Grid className="profile__main" container component={Card} elevation={5} xs={12} md={8}>
                        <Grid className="profile__main__header" container direction="row" alignItems="center" xs={12}>
                            <Avatar
                                variant="square" 
                                src={user?.avatar?.url}
                                alt={user?.name}
                    ...
                    <Grid container direction="row" justifyContent="center" className="profile__main__bar">
                        <Grid item component={Link} to="/myprofile/orders" xs={4}>
                        ...
                        <Grid item component={Link} to="/myprofile" xs={4}>
                            <Grid direction="column" component={Button} container >
                                <Grid item>
                                    <IconButton>
                                        <PermIdentityIcon />
                        ...
                        <Grid item component={Link} to="/myprofile/settings" xs={4}>
                            <Grid direction="column" component={Button} container >
                                <Grid item>
                                    <IconButton>
                                        <SettingsIcon />
                    ...
                    <Grid container align="left" direction="column" xs={12}>
                        ...
                        <Grid item>
                            <Typography variant="h5">
                                {!loading ? String(user.createdAt).substring(0, 10) : <Skeleton width={400} />}
                            </Typography>
                        </Grid>
                    </Grid>
                </Grid>
