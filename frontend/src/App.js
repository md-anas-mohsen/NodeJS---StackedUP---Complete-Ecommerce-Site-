...
function App() {
  ...
  useEffect(() => {
    const queryStringObject = {
      ...
      price: price[0] > 1 || price[1] < 100000 ? `price[gte]=${price[0]}&price[lte]=${price[1]}` : "",
      ...
      <Router>            
        ...
        <div className="App">
          ...
          <Switch>
              ...
              <ProtectedRoute path="/myprofile/orders" exact component={Profile} />
              <ProtectedRoute path="/myprofile/settings" exact component={Profile} />
              <ProtectedRoute path="/myprofile" exact component={Profile} />
              <ProtectedRoute path="/dashboard" exact component={Dashboard} />
              <Route path="/signin" exact component={Login} />
              <Route path="/signup" exact component={Signup} />
              <Route path="/forgotpassword" exact component={ForgotPassword} />
              <Route path="/password/reset/:token" exact component={ChangePassword} />
