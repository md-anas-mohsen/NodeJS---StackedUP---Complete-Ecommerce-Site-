...
import { CAlert, CAvatar, CBadge, CButton, CCard, CCardBody, CCardHeader, CCol, CForm, CFormCheck, CFormControl, CFormLabel, CModal, CModalBody, CModalFooter, CModalHeader, CModalTitle, CRow, CSpinner } from '@coreui/react'
                ...
                <CCardHeader>
                    <CRow className="my-2 align-items-center justify-items-space-between">
                        <CCol xs="12" className="d-flex align-items-center mt-2">
                            <CAvatar className="mx-2" size="xl" shape="rounded-circle" color="secondary" textColor="white" src={user.avatar?.url !== "no avatar" && user.avatar?.url}>{user.avatar?.url === "no avatar" && user.name?.slice(0, 1)}</CAvatar>
                ...
                <CCardBody>
                    ...
                    <CForm onSubmit={handleSubmit}>
                        <CRow className="mb-3">
                            ...
                            <CCol sm="10">
                            <CFormControl value={name} onChange={(e) => setName(e.target.value)} type="input" id="userName" />
                            </CCol>
                        </CRow>
                        <CRow className="mb-3">
                            ...
                            <CCol sm="10">
                            <CFormControl value={email} onChange={(e) => setEmail(e.target.value)} type="email" id="userEmail" />
                            </CCol>
                        </CRow>
